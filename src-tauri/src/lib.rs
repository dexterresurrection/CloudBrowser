...
pub fn run() {
  ...
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      public_proxy::cloud_get_countries,
      personal_proxy::personal_proxy_get_servers,
      personal_proxy::personal_proxy_get_list,
      personal_proxy::personal_proxy_check_subscription,
      personal_proxy::personal_proxy_create,
      personal_proxy::personal_proxy_delete,
      personal_proxy::personal_proxy_save_settings,
      personal_proxy::personal_proxy_get_settings,
      public_proxy::cloud_get_regions,
      public_proxy::cloud_get_cities,
      public_proxy::cloud_get_isps,
      public_proxy::create_cloud_location_proxy,
